...
const widgetNames = {
  ...
  MeanLeadFixTime: "Mean Lead Fix Time (s)",
  ...
  MeanPullRequestResponseTime: "Mean Pull Response Time (s)",
  PullRequestCount: "Pull Request Count",
  MeanLeadTimeForPulls: "Pulls Mean Lead Time (s)",
  ResponseTimeforIssue: "Issue Response Time (s)",
};
